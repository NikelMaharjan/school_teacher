...
//
//
// class AddCoursePlan extends ConsumerStatefulWidget {
//
//   final TeacherClassCourse teacherClassCourse;
//   AddCoursePlan({required this.teacherClassCourse});
//
//   @override
//   _AddCoursePlanState createState() => _AddCoursePlanState();
// }
//
// class _AddCoursePlanState extends ConsumerState<AddCoursePlan> {
...
//                     ref.read(coursePlanProvider.notifier).addPlan(
//                         token: auth.user.token,
//                         duration: teachingDuration,
//                         description: description,
//                         outcome: expectedOutcome,
//                         course: widget.teacherClassCourse.id
