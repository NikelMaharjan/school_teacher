...
class Student_Assignment extends ConsumerWidget {
  final int class_id;
  final String className;
  final String section;
  final Assignment assignment;

  Student_Assignment({required this.class_id,required this.section,required this.className,required this.assignment});
